<template>
  <div class="results-modal" v-bind:class="{ hide: !isVisible }">
    <div class="results-content">
      <span @click='onClose' class="close">
        <img alt="Close Modal" aria-label="close the popup modal window and return to the form" src="../assets/closemodal.png">
      </span>
